module.exports = {
	...
	execute(message, args, Discord) {
		...
		const newEmbed = new Discord.MessageEmbed()
			...
			.addFields(
				{ name: '~help', value: `Bot'un tüm komutlarını gösteren bir yardım komutu.` },
				{ name: '~discordlink', value: `Discord davet linkini kullanıcıya mesaj olarak yollayan bir komut.` },
